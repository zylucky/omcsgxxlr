...
<template>
    <div class="all_elements">
        <div class="build_top">
            <ul class="ys_item_ul mb60">
                <li class="clearfix">
                    ...
                    <div class="ys_item_con fl">
                        <input type="text" value="" :readonly="true" onfocus="this.blur()" v-model="topic" placeholder="请输入">
                    </div>
                </li>
                <li class="clearfix">
                    <span class="ys_tit">性别：</span>
                    <div class="ys_item_con fl">
                        <label class="mr20"><input type="radio" disabled v-model="xb" value="1" name="sex">男</label>
                        <label ><input type="radio" v-model="xb" disabled value="0" name="sex">女</label>
                    </div>
                </li>
                <li class="clearfix">
               ...
               <!-- <li class="clearfix bg_gray">
                ...
                <li class="clearfix pr">
                    ...
                    <div class="ys_item_con fl">
                        <input type="text" value="" :readonly="true" onfocus="this.blur()" v-model="wxh" placeholder="请输入">
                    </div>
                </li>
                <li class="clearfix pr">
                    <span class="ys_tit w224">常驻工作地：</span>
                    <div class="ys_item_con fl">
                        <input type="text" value="" :readonly="true" onfocus="this.blur()" v-model="czaddress" placeholder="请输入">
                    </div>
                </li>
                <li class="clearfix pr">
                    <span class="ys_tit">现工作地：</span>
                    <div class="ys_item_con fl">
                        <input type="text" value="" :readonly="true" onfocus="this.blur()" v-model="xaddress" placeholder="请输入">
                    </div>
                </li>
                <li class="clearfix pr">
                    <span class="ys_tit">现状：</span>
                    <div class="ys_item_con fl">
                        <input type="text" value="" :readonly="true" onfocus="this.blur()" v-model="xzh" placeholder="请输入">
                    </div>
                </li>
                ...
                <li class="clearfix pr">
                    ...
                    <div class="ys_item_con fl">
                        <input type="number" value="" :readonly="true" onfocus="this.blur()" v-model="kczts" placeholder="请输入">
                    </div>
                </li>
                <li class="clearfix">
                    <span class="ys_tit w224">在京有公司：</span>
                    <div class="ys_item_con fl">
                        <label class="mr20" @click="sfygsclass"><input type="radio" value="1" disabled v-model="sfygs" name="company">有</label>
                        <label @click="sfygsclass"><input type="radio" value="0" disabled v-model="sfygs" name="company">无</label>
                    </div>
                </li>
                ...
                <li class="clearfix pr">
                    ...
                    <div class="ys_item_con fl">
                        <input type="text" value="" :readonly="true" onfocus="this.blur()" v-model="qt" placeholder="请输入">
                    </div>
                </li>
                <li class="clearfix pr">
                    <span class="ys_tit w224">预估资产：</span>
                    <div class="ys_item_con fl">
                        <input type="number" value="" :readonly="true" onfocus="this.blur()" v-model="ygzc" placeholder="请输入">
                    </div>
                </li>
            ...
            <a href="javascript:;" class="ys_default_btn mb80" @click="saveOwnerData">返回</a>
        </div>
    </div>
</template>
<script>
        ...
        methods: {
            ...
            getInitData(){
                ...
                this.$http.post(url, {"parameters":{ "id":yzid},"foreEndType":2,"code":"300000032"}).then((res)=>{
                    ...
                    let gs12 = gsname111 ? gsname111.split(";"):[""];
                    that.gsname = gs12.map((c)=>{return {"name":c}});
                    that.qt = data.qt;
                    that.ygzc = data.ygzc;
