        ...
        <div class="build_top">
            <ul class="ys_item_ul mb60">
                ...
                <li class="clearfix">
                    ...
                    <div class="ys_item_con fl">
                        <input type="text" class="inp_sm" value="2301" v-model="fybh" readonly onfocus="this.blur()">
                        <span class="hor_line"></span>
                        <input type="text" class="inp_sm" value="" :readonly="true" onfocus="this.blur()" v-model="fh" placeholder="请输入">
                    </div>
                </li>
                <li class="clearfix pr">
                    <span class="ys_tit">租赁面积：</span>
                    <div class="ys_item_con fl">
                        <input type="number" value="" :readonly="true" onfocus="this.blur()" v-model="zlmj" placeholder="请输入">
                ...
                <li class="clearfix pr">
                    ...
                    <div class="ys_item_con fl">
                        <input type="number" value="" :readonly="true" onfocus="this.blur()" v-model="xzhzj" placeholder="请输入">
                ...
                <li class="clearfix">
                    ...
                    <div class="ys_item_con fl">
                        <input type="text" value="" :readonly="true" onfocus="this.blur()" v-model="fkfs" placeholder="请输入">
                    </div>
                </li>
                <li class="clearfix">
                    <span class="ys_tit">联系方式：</span>
                    <div class="ys_item_con fl">
                        <input type="text" value="" :readonly="true" onfocus="this.blur()" v-model="lxfs" placeholder="请输入">
                    </div>
                </li>
                <div class="hy_class" >
                    <li class="clearfix">
                        ...
                        <div class="ys_item_con fl">
                            <input type="text" value="" :readonly="true" onfocus="this.blur()" v-model="sshy" placeholder="请输入">
                        </div>
                    </li>
                    <li class="clearfix">
                        <span class="ys_tit">公司人数：</span>
                        <div class="ys_item_con fl">
                            <input type="number" value="" :readonly="true" onfocus="this.blur()" v-model="gsrs" placeholder="请输入">
                        </div>
                    </li>
                    ...
                    <li class="clearfix">
                        ...
                        <div class="ys_item_con fl">
                            <input type="text" value="" :readonly="true" onfocus="this.blur()" v-model="jyhj" placeholder="请输入">
                        </div>
                    </li>
                </div>
            </ul>
            <a href="javascript:;" class="ys_default_btn mb80" @click="saveRentData">返回</a>
        </div>
