        ...
        <div class="build_top">
            <ul class="ys_item_ul mb60">
                ...
                <li class="clearfix">
                    ...
                    <div class="ys_item_con fl">
                        <label class="mr20"><input type="radio" v-model="xb" disabled value="1" name="sex">男</label>
                        <label ><input type="radio" name="sex" v-model="xb" disabled value="0">女</label>
                    </div>
                </li>
                <li class="clearfix">
                ...
                <li v-for="(ph,idx) in phone" class="clearfix">
                    ...
                    <div class="ys_item_con fl pos"><!--:value="ph.phone"-->
                ...
                <li class="clearfix pr">
                    ...
                    <div class="ys_item_con fl">
                        <input type="text" value="" :readonly="true" onfocus="this.blur()" v-model="address" placeholder="请输入">
                    </div>
                </li>
                <li class="clearfix pr">
                    <span class="ys_tit">职业：</span>
                    <div class="ys_item_con fl">
                        <input type="text" value="" :readonly="true" onfocus="this.blur()" v-model="zy" placeholder="请输入">
                    </div>
                </li>
                <li class="clearfix pr">
                    <span class="ys_tit w224">与业主关系：</span>
                    <div class="ys_item_con fl">
                        <input type="text" value="" :readonly="true" onfocus="this.blur()" v-model="yyzgx" placeholder="请输入">
                    </div>
                </li>
                <li class="clearfix">
                    <span class="ys_tit w224">有无签约权：</span>
                    <div class="ys_item_con fl">
                        <label class="mr20"><input type="radio" name="visa" disabled v-model="qyq" value="1">有</label>
                        <label ><input type="radio" name="visa" disabled v-model="qyq" value="0">无</label>
                    </div>
                </li>
            </ul>
            <a href="javascript:;" class="ys_default_btn mb80" @click="saveAgentData">返回</a>
        </div>
    </div>
</template>
<script>
