...
<template>
  <div class="all_elements">
    <div class="build_top">
      ...
      <h3 class="ptitle"><span class="ys_tit">对签约谈判的满意程度</span></h3>
      <ul class="ys_item_ul">
        <li class="clearfix">
      ...
      <ul class="ys_item_ul">
        <li class="clearfix">
          <span class="ys_tit nor">合作意向：</span>
          <div class="ys_item_con  input-out fl thirinp">
            <div class="uit-raio">
              <input type="radio" name="sex" id="hz1">
              <label for="hz1">A</label>
            </div>
            <div class="uit-raio">
              <input type="radio" name="sex" id="hz2">
              <label for="hz2">B</label>
            </div>
            <div class="uit-raio">
              <input type="radio" name="sex" id="hz3">
              <label for="hz3">C</label>
            </div>
          </div>
        </li>
      </ul>
      <div class="btn-out clearfix">
        ...
        <button class="initfile fr">形成约见</button>
      </div>
    </div>
  </div>
</template>
